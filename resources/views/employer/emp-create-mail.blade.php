						...
						<div class="col-xl-12 col-lg-12 m-b30">
							<div class="job-bx job-profile">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 float-start text-uppercase">Create Email Template</h5>
								</div>
								<form>
									<div class="row m-b30">
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												<label>Template Name <span class="imp-field-star">*</span></label>
									...
									<button class="site-button m-b30">Preview</button>
