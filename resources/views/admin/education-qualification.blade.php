        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid jobseeker-view-page">
                    ...
                    <!-- edit-education-qualification-modal content -->
                    <div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">

                                <div class="modal-header">
                                    <h4 class="modal-title" id="topModalLabel">Edit Education Qualification</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="ps-3 pe-3" id="dataUpdate">
                                        ...
                                        <div class="mb-3">
                                            <label for="mobile-number" class="form-label">Qualification Level</label>
                                            <div class="input-group">
                                               <select id="element1" name="element1"  class="form-select" style="padding: 5px 0px 5px 5px;">
