                                ...
                                <div class="card-header jobseeker-header">
                                    <div class="btn-group mb-2 jobsee-header-tabs">
                                        ...
                                        <a class="btn btn-primary main-button editElement" role="button" data-bs-toggle="modal"
                                            data-bs-target="#add-state-modal" data-modal_cat='add'>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title" id="topModalLabel">Add State</h4>
                                    ...
                                    <form class="ps-3 pe-3" id="dataUpdate">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                               <select class="form-select" id="element2" name="element2" style="padding: 5px 0px 5px 5px;">
                                                  @foreach (getDropDownlist('country_master', ['country_name', 'id']) as $country_master)
										<option value="{{ $country_master->id}}" >{{ $country_master->country_name}}</option>
										@endforeach 
                                               </select>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" id="customRadio3" name="status" value="1"
                                                    class="form-check-input status">
                                                <label class="form-check-label" for="customRadio3">Approved</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" id="customRadio4" name="status" value="0"
