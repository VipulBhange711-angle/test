                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                      ...
                                      <form class="ps-3 pe-3" id="dataUpdate">
                                        ...
                                        <div class="mb-3">
                                            <label for="companyname" class="form-label">Notice Period Name</label>
                                             <input class="form-control" type="text" id="element1" name="element1" required=""
                                                placeholder="">
                                                <input type="text"  name="type"  value="notice" id="type" hidden>
