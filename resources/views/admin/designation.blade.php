                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title" id="topModalLabel">Add Designation</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="ps-3 pe-3" id="dataUpdate">
                                        ...
                                        <div class="mb-3">
                                            <label for="companyname" class="form-label">Designation</label>
                                             <input class="form-control" type="text" id="element1" name="element1" required=""
                                                placeholder="">
                                                <input type="text"  name="type"  value="designation" id="type" hidden>
